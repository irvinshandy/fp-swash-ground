...
public class XBee implements IXBee {
     ...
     */
    public XBeeResponse sendSynchronous(final XBeeRequest xbeeRequest, int timeout) throws XBeeException {
     ...
     */
    public XBeeResponse sendSynchronous(final XBeeRequest request) throws XBeeException {
